...
def _run_chat_button_visibility():
    ...
    try:
        ...
        if hasattr(main_win, "chat_button"):
            print("   [OK] Chat button object exists")
            ...
            print("   [FAIL] Chat button object not found")
        ...
        if hasattr(main_win, "chat_button"):
            ...
            print(f"│ 💬 Text: '{button.text()}'                                │")
            print(f"│ [CHECK] Tooltip: '{button.toolTip()}'        │")
        ...
        print("2. [CHECK] Look for a blue circular button with 💬 emoji")
